...
<Tabs>
  <TabItem value='login-use' label='Usage'>
    ...
    * `paths` *(optional)*: List of [SLIP-48](https://github.com/satoshilabs/slips/blob/master/slip-0048.md) paths to be used for wallets that support it to skip account search
