...
| 4003       | Network Error           | A network error occured during the operation.                            |
...
| 5006       | Invalid Amount          | Amount must be greater than or equal to 0.                               |
| 5007       | Empty transaction       | There are no operations in the transaction.                              |
