...
|`discOptions`|Account discovery options for supported providers. Details [here](/docs/core/usage#discover-accounts).||
...
|`messages`|Custom [`Messages`](/docs/ui/i18n#the-messages-adapter) adapter for routing translations through your own i18n framework. Defaults to the built-in adapter.|*undefined*|
