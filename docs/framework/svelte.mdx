...
```html title="src/components/AiohaPage.svelte"
<script lang="ts">
...
Listen for [events](/docs/core/jsonrpc#events) using lifecycle functions within Svelte components.

```html title="src/components/YourComponent.svelte"
<script lang="ts">
